    ...
    async def _run(self) -> None:
        try:
            ...
            while True:
                ...
                # Sleep until the next tick. We compute the deadline up
                # front so a slow set() doesn't drift the cadence.
                tick_deadline = time.monotonic() + self.TICK_S
